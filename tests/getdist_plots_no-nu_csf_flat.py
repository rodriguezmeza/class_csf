#
# Execute:
# $ python getdist_plots_no-nu_csf_flat.py > getdist_no-nu_csf_flat.txt
#

# Export the results to GetDist
from cobaya import load_samples
chaindir1 = "chains_flat/chain"
legend1 = "BAO DR2"
color1 = 'orange'
ls1 = '-'
line1 = {'ls':ls1, 'lw':1.0, 'color':color1}
folder = "results_bao_dr2_flat/"
huevos = folder + "huevos_csf_bao_dr2.pdf"
#
huevos_Q_n_2d = folder + "huevos_csf_bao_dr2_Q_n_2d.pdf"
huevos_OL_n_2d = folder + "huevos_csf_bao_dr2_OL_n_2d.pdf"
#
huevos_Om_OL_2d = folder + "huevos_csf_bao_dr2_Om_OL_2d.pdf"
huevos_H0_Om_2d = folder + "huevos_csf_bao_dr2_H0_Om_2d.pdf"
huevos_Om_1d = folder + "huevos_csf_bao_dr2_Om_1d.pdf"
covariance_file_1 = folder + "covmat_emt_bao_dr2.txt"

parameters = ["Omega_m",  "Omega_Lambda", "H0", "omega_b",
            "QCSF"]
parameters_H0_Om = ["H0",  "Omega_m"]
...
redMarkersLabels = {'Omega_m': 0.3142, 'Omega_Lambda':0.6858, 'H0':67.39,
    'omega_b': 0.02229, 'Omega_k': 0.00, 'sigma8':0.8091, 'QCSF':0}
...
samples_bao=[gd_sample1]
legends_triangle_bao = [legend1]
contourcolors_triangle_bao=[color1]
parameters_triangle = ["Omega_m", "Omega_Lambda", "QCSF", "T_cmb_CSF", "H0_CSF"]
gdplot = gdplt.get_subplot_plotter()
gdplot.settings.legend_fontsize = 20
gdplot.settings.axes_fontsize = 20
gdplot.settings.lab_fontsize = 30
gdplot.triangle_plot(samples_bao,
    parameters_triangle, filled=True,
    legend_labels=legends_triangle_bao, legend_loc=legendloc,
    contour_colors=contourcolors_triangle_bao, line_args=lineargs,
    markers=redMarkersLabels,
    marker_args=marker_args,
    fontsize=20,
    )
gdplot.export(huevos)
...
parameters_ResultsTable = ["logA", "n_s", "H0", "omega_b", "omega_cdm", "m_ncdm", "tau_reio", "Omega_m",  "Omega_Lambda", "H0_CSF", "omega_b",
            "QCSF", "T_cmb_CSF"
            "A_s"]
print()
print()
